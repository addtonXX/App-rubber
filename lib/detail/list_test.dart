...
class List_page extends StatefulWidget {
  const List_page({Key? key, required user}) : super(key: key);
...
class _List_pageState extends State<List_page> {
  List<User> users = [
    const User(
        name: 'โรคที่เกิดจากเชื้อคอลเลตโตริกัม',
        namerubber: '',
        boxname:
...
''',
        urlAvatar: 'assets/07.png'),

    const User(
        name: 'โรคเปลือกเน่า',
        namerubber: '(Mouldy rot) ',
        boxname: '''เชื้อสาเหตุเชื้อรา Ceratocystis fimbriata
...
การป้องกันกำจัด
 ...
 ''',
        urlAvatar: 'assets/08.png'),
//---------------------------------------------------------------
    const User(
        name: 'โรคเปลือกแห้ง',
        namerubber: '',
        urlAvatar: 'assets/09.png',
        boxname: '''ที่มา : กรมวิชาการเกษตร
...
ยางที่เปิดกรีดแล้วและเป็นโรคเปลือกแห้งเพียงบางส่วน
    ...
    const User(
        name: 'โรคเส้นดำ ',
        namerubber: '(Black Stripe)',
        urlAvatar: 'assets/10.png',
        boxname: ''' ที่มา : กรมวิชาการเกษตร
...
'''),
    //---------------------------------------------------------------
    const User(
        name: 'โรคใบจุดก้างปลา',
        namerubber: ' (Corymespora cassiicola)',
        urlAvatar: 'assets/11.png',
        boxname: '''ที่มา : กรมวิชาการเกษตร
...
ลักษณะอาการ
    ...
    const User(
        name: 'โรคใบจุดตานก',
        namerubber: 'Drechslera (Helminthosporium) heveae',
        urlAvatar: 'assets/12.png',
        boxname: '''ที่มา : กรมวิชาการเกษตร
...
ลักษณะอาการ
    ...
    //---------------------------------------------------------------
    const User(
        name: 'โรคใบร่วงและฝักเน่า ',
        namerubber: '(Phytophthora leaf fall and pod rot)',
        urlAvatar: 'assets/13.png',
        boxname: ''' ที่มา : กรมวิชาการเกษตร
...
การป้องกันกำจัด
    ...
    const User(
        name: 'โรคราแป้ง',
        namerubber: '(Oidium Leaf Disease)',
        urlAvatar: 'assets/14.png',
        boxname: '''ที่มา : กรมวิชาการเกษตร
...
สภาพต้นยาง ช่วงยางผลิใบใหม่'''),
    ...
    const User(
        name: 'โรครากแดง',
        namerubber: '(Red root disease)',
        urlAvatar: 'assets/15.png',
        boxname: ''' ที่มา : กรมวิชาการเกษตร
...
การป้องกันกำจัด
    ...
    const User(
        name: 'โรคราสีชมพู',
        namerubber: '(Pink Disease)',
        urlAvatar: 'assets/17.png',
        boxname: ''' ที่มา : กรมวิชาการเกษตร
...
การป้องกันกำจัด
    ...
    //---------------------------------------------------------------
    const User(
        name: 'โรคใบร่วงและผลเน่าที่เกิดจากเชื้อไฟท้อปโทร่าง',
        namerubber: '(Phytophthora Leaf Fall)',
        urlAvatar: 'assets/18.png',
        boxname: '''ที่มา : กรมวิชาการเกษตร
...
การป้องกันกำจัด
    ...
    //---------------------------------------------------------------
    const User(
        name: 'โรคใบที่เกิดจากเชื้อออยเดียม',
        namerubber: '(Oidium Leaf Disease)',
        urlAvatar: 'assets/19.png',
        boxname: '''ที่มา : กรมวิชาการเกษตร
...
การป้องกันกำจัด
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Container(child: Text('ค้นหาโรคต้นยางพารา')),
        actions: <Widget>[
          Padding(
            ...
            return Card(
              child: ListTile(
                leading: CircleAvatar(
                    radius: 28, backgroundImage: AssetImage(user.urlAvatar)),
                title: Text(user.name),
                subtitle: Text(user.namerubber),
